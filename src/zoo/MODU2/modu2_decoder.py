...
from src.nn.transformer import (
    ...
    DinoTransformerDecoder_return_query,
...
__all__ = ["MODU2decoder"]


@register
class MODU2decoder(nn.Module):
    ...
    def __init__(
        ...
        self.decoder = DinoTransformerDecoder_return_query(
